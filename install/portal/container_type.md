...
- Portal Deployment Git Repository URL : https://github.com/PaaS-TA/portal-deployment/tree/v5.2.13
...
# Deployment 파일 다운로드
$ git clone https://github.com/PaaS-TA/portal-deployment.git -b v5.2.13
```
...
portal-app-1.2.4
├── portal-api-2.4.1
├── portal-common-api-2.2.2
├── portal-gateway-2.1.0
├── portal-log-api-2.2.0
├── portal-registration-2.1.0
├── portal-ssh-1.0.0
├── portal-storage-api-2.2.1
├── portal-web-admin-2.3.2
└── portal-web-user-2.4.2
```
