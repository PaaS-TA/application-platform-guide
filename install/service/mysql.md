...
본 가이드의 Stemcell은 ubuntu-bionic 1.79를 사용한다.  
...
bosh-openstack-kvm-ubuntu-bionic-go_agent  1.79      ubuntu-bionic  -    ce507ae4-aca6-4a6d-b7c7-220e3f4aaa7d
...
- Service Deployment Git Repository URL : https://github.com/PaaS-TA/service-deployment/tree/v5.1.7
...
# Deployment 파일 다운로드
$ git clone https://github.com/PaaS-TA/service-deployment.git -b v5.1.7
```
