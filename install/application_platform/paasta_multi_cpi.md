...
multi-cpi-deployment는 paasta-deployment v5.6.3의 설치를 기준으로 가이드를 작성하였다.  
...
$ git clone https://github.com/PaaS-TA/multi-cpi-deployment.git -b v5.6.3
```
...
```
# paasta-deployment v5.6.3와 동일한 Stemcell인 ubuntu-bionic 1.34를 사용한다.
